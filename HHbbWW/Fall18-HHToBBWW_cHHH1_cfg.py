...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('POWHEG:nFinal = 2', 
            #'23:mMin = 0.05',         #Turn off, only want Higgs decay to b,W  
            #'23:onMode = on',         #Turn off, only want Higgs decay to b,W 
            '24:mMin = 0.05',              
            '24:onMode = on',         
            '25:m0 = 125.0', 
            '25:onMode = off', 
            '25:onIfMatch = 5 -5', 
            #'25:onIfMatch = 23 23',   #Turn off, only want Higgs decay to b,W 
            '25:onIfMatch = 24 -24',  
            ...
            'ResonanceDecayFilter:daughters = 5,5,24,-24'      #daughters are 5=b, 24=W
